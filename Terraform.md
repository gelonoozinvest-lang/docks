...
См. `Vault Namespace Specification .md` для получения дополнительной информации о структуре секретов.
5. Интеграция с n8n
...
См. `Module Design Specification.md` для получения дополнительной информации о проектировании модулей.
7. GitOps
